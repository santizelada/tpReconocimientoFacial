...
# bar1 = plt.bar(x,y)
# # my_colors = 'rgbykmc'
# my_colors = ['red', 'green', 'blue', 'yellow', 'black', 'magenta', 'cyan']
...
plt.ion()
figura1 = plt.figure()
bar1 = plt.bar(x, y, color=['red', 'green', 'blue', 'yellow', 'black', 'magenta', 'cyan'], width=1)
...
while True:
    ...
    for (box, pred) in zip(locs, preds):
        ...
        plt.grid(True)
        plt.ylim([0.0, 1.0])
        plt.bar(x, y, color=['red', 'green', 'blue', 'yellow', 'black', 'magenta', 'cyan'], width=1)
        figura1.canvas.draw()
        plt.pause(0.01)
